...
class CompanyProductsViewController: IndicatorViewableViewController {
...
extension CompanyProductsViewController {
...
extension CompanyProductsViewController: BackButtonProtocol, UIGestureRecognizerDelegate {
...
extension CompanyProductsViewController: UICollectionViewDelegateFlowLayout, UICollectionViewDataSource {
...
extension CompanyProductsViewController {
    ...
    @objc func getProducts() {
        ...
        NetworkLayer.shared.sendRequest(command: NetworkRouter.getProductsWithoutFilter(company_id)) { [unowned self] optional in
